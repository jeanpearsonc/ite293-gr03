...
<body>
  ...
  <section class="row jumbotron">
    ...
    <div class="col-sm-8"><p>Maintenance is the process of modifying an information system to continually satisfy organizational and user requirements. There is a vast difference between hardware and software maintenance in costs as well as in objectives. ... - changing the application to adapt it to a new hardware or software environment.
